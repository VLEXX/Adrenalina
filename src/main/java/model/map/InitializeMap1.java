...
public class InitializeMap1 implements StrategyMap, Serializable {
    ...
    public Map initializeMap() {
        ...
        cell5.setSpawnpointzone(spawnPointRed);
        cell11.setSpawnpointzone(spawnPointYellow);
